...
export default function HomePage() {
  ...
  return <main id="main-content" className="page home-page">
    <section className="home-intro">
      ...
      <p className="intro-copy">Hi, I’m Lit En. An engineer who likes to analyse problems and design solutions. This is where I keep my learning notes, research, and moments along the way.</p>
    ...
    <div className="notebook-layout">
      ...
      <aside className="notebook-sidebar" aria-label="Notebook margin">
        ...
        <section className="margin-section margin-checkpoints"><span className="tiny-star" aria-hidden="true">✳</span><h2>A few moments<br />that shaped me.</h2><p>People, projects, and places along the way.</p><Link className="underlined-link" href="/checkpoints/">Life checkpoints ↗</Link></section>
        <MailingList compact />
      </aside>
    </div>
  </main>;
